...
public class Chemin {
    ...
    /**
     * @param start: [vuecontroleur.VueCase] Case départ du chemin
     * @author Evan SEDENO
     * @brief Constructeur de la classe model.Chemin
     * @details - On assigne la vuecontroleur.VueCase passé en paramètre à l'attribut start
     */
    ...
    /**
     * @return this.start: [vuecontroleur.VueCase] Attribut start
     * @author Evan SEDENO
    ...
    /**
     * @return this.stop: [vuecontroleur.VueCase] Attribut stop
     * @author Evan SEDENO
    ...
    /**
     * @return this.way: [List<vuecontroleur.VueCase>] Attribut way
     * @author Evan SEDENO
     ...
     * @details - On renvoie la liste de vuecontroleur.VueCase de l'attribut way sans le depart et l'arrivée
     */
    public List<VueCase> getWayWithoutStartAndStop() {
        //On créer une nouvelle liste de vuecontroleur.VueCase
    ...
    /**
     * @param stop: [vuecontroleur.VueCase] Valeur de la case d'arrêt du chemin
     * @author Evan SEDENO
     * @brief Mutateur de l'attribut stop
     * @details - On assigne la valeur du paramètre stop à l'attribut stop
     * @details - On rajoute à la liste des vuecontroleur.VueCase du chemin la vuecontroleur.VueCase stop en paramètre
     */
    ...
    /**
     * @param start: [vuecontroleur.VueCase] Valeur de la case de depart du chemin
     * @author Evan SEDENO
     ...
     * @details - On appelle la methode de la vuecontroleur.VueCase pour assigner un depart avec la vuecontroleur.VueCase passé en paramètre le start
     */
    ...
    /**
     * @param newcase: [vuecontroleur.VueCase] Valeur d'une case du chemin
     * @author Evan SEDENO
     * @brief Mutateur spécifique de l'attribut way
     * @details - On rajoute à l'attribut way la nouvelle vuecontroleur.VueCase passé en paramètre
     */
    ...
    /**
     * @param chemins: [List<model.Chemin>] Liste de l'ensemble des chemins
     * @author Evan SEDENO
    ...
    /**
     * @param chemins: [List<model.Chemin>] Liste de tous les chemins
     * @author Evan SEDENO
    ...
    /**
     * @param firstcase: [vuecontroleur.VueCase] Case avant la case à dessiner
     * @param drawcase:  [vuecontroleur.VueCase] Case à dessiner
     * @param lastcase:  [vuecontroleur.VueCase] Case après la case à dessiner
     * @author Evan SEDENO
    ...
    public boolean checkGoodChemin() {
        ...
        if (this.getStart() != null && this.getWay().size() > 2) {
            //On parcourt chaque case du chemin
            for (int i = 1; i < this.getWay().size(); ++i) {
                boolean cond1 = this.getWay().get(i).getCase().getX() == (this.getWay().get(i - 1).getCase().getX() + 1);
                boolean cond2 = this.getWay().get(i).getCase().getX() == (this.getWay().get(i - 1).getCase().getX() - 1);
                boolean cond3 = this.getWay().get(i).getCase().getY() == (this.getWay().get(i - 1).getCase().getY() + 1);
                boolean cond4 = this.getWay().get(i).getCase().getY() == (this.getWay().get(i - 1).getCase().getY() - 1);

                //On vérifie que toutes les cases du chemin se suivent
                if ((!cond1 && !cond2 && !cond3 && !cond4) || (cond1 && cond3) || (cond1 && cond4) || (cond2 && cond3) || (cond2 && cond4)) {
                    return false;
                }
            }
        }
