 ...
 * @author Evan SEDENO
 * @date 07/12/2021
 * @file vuecontroleur.VueControleurMenu.java
...
public class VueControleurMenu extends JFrame {
    ...
    /**
     * @author Evan SEDENO
     * @brief Constructeur de la class vuecontroleur.VueControleurMenu
    ...
    /**
     * @param user: [model.User] Utilisateur à attribuer à l'attribut user
     * @author Evan SEDENO
     * @brief Mutateur de l'attribut user
     * @details On donne à l'attribut user la valeur de l'model.User passé en paramètre
     */
     ...
     * @details - On affiche un bouton avec un listener pour chaque niveau disponible (avec une instanciation de la class model.Jeu)
     * @details - On créer un bouton retour
     * @details - On ajoute tout le contenu au JPanel du Menu
     */
