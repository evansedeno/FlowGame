...
public class Files {
     ...
     * @param grille: [ModelGrille] Grille du niveau
     * @author Evan SEDENO
     ...
     * @return mycase: [CaseType] Objet CaseType de type enum de la case correspondante à une certaine position dans un niveau
     * @author Evan SEDENO
    ...
    /**
     * @return levels: [ArrayList<User>] Liste des utilisateurs
     * @author Evan SEDENO
    ...
    public ArrayList<User> getAllUsers() {
        ...
        try {
            ...
            //On récupère chaque information de chaque utilisateur et on instancie la classe User
            for (int i = 0; i < content.size(); ++i) {
     ...
     * @return user: [User] Utilisateur récupéré par son nom
     * @author Evan SEDENO
