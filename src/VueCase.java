...
public class VueCase extends JPanel {
    ...
    /**
     * @author Frédéric ARMETTA & Evan SEDENO
     * @brief Constructeur de la class VueCase
     * @details - On assigne à l'attribut "c" une instanciation de la classe ModelCase avec en paramètre les paramètres donnés au constructeur
     */
    ...
    /**
     * @return this.c: [VueCase] Retourne l'attribut "c"
     * @author Evan SEDENO
    ...
    /**
     * @param starter: [VueCase] Objet VueCase à assigner
     * @author Evan SEDENO
     * @brief Mutateur de l'attribut starter
     * @details - On assigne à l'attribut la valeur de l'objet VueCase en paramètre
     */
    ...
    /**
     * @param chemin: [Chemin] Chemin envoyé pour le croisement
     * @author Evan SEDENO
    ...
    /**
     * @return this.firsttype: [VueCase] Retourne l'attribut firsttype
     * @author Evan SEDENO
    ...
    /**
     * @return this.lasttype: [VueCase] Retourne l'attribut lasttype
     * @author Evan SEDENO
    ...
    /**
     * @return this.otherstarter: [VueCase] Retourne l'attribut otherstarter
     * @author Evan SEDENO
